...
public class HTMLTextConverter 
{
			...
			throws IOException, FileNotFoundException, NullPointerException
	{
		...
		try
		{
			File dir = new File("C:\\Users\\Asmita\\eclipse-workspace\\MyWebSearchEngine\\src\\HTMLFiles\\");
			...
			for (File file : files) 
			{
				...
				bufferedWriter = new BufferedWriter(new FileWriter(
						"C:\\Users\\Asmita\\eclipse-workspace\\MyWebSearchEngine\\ConvertedTextFiles\\" + myString + ".txt"));
