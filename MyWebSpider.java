...
public class MyWebSpider 
{
	...
	public void saveUrl(final String filename, final String stringUrl) throws MalformedURLException, IOException {
		{
			try 
			{
				...
				BufferedWriter bufferedWriter = new BufferedWriter(
						new FileWriter("C:\\Users\\Asmita\\eclipse-workspace\\MyWebSearchEngine\\src\\HTMLFiles\\" + stringFilename));
	...
	public static void main(String[] args) 
	{
		...
		int initialDepth = 0;
		// examples of seed value can be https://www.wikipedia.org/ , http://www.uwindsor.ca/ and so on
		myWebSpider.getPageLinks("http://www.uwindsor.ca/", initialDepth);
	}
}
